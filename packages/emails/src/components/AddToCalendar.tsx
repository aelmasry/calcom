      ...
      <div
        ...
        <Link href={googleCalendarLink}>
          <a target="_blank"
            ...
            <img src="https://icons8.com/icon/85834/google" alt="Google Calendar" style="width: 40px; height: 40px;" />
            {/* <svg
...
<img src="https://icons8.com/icon/100638/microsoft-outlook" alt="Microsoft Outlook" style="width: 40px; height: 40px;" />
